...
This repo conforms to the [Agent-Ready Documentation Standard v1.0](https://github.com/Rob-Morris/obsidian-brain/blob/main/docs/standards/agent-ready-documentation.md). Adoption notes and current maturity sit in [docs/contributor/documentation-standard.md](contributor/documentation-standard.md).
...
- [Contributor](contributor/README.md) — how to contribute: working rules, repo structure, change discipline, documentation standard adoption.
...
- [CHANGELOG.md](CHANGELOG.md) — version history index; links to one file per shipped version under `docs/changelog/`.
