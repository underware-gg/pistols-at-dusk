...
Shared documentation standards used by this repo.

Current contents:

- [Versioning](versioning.md) — pre-1.0 semver, one-version-per-commit invariant, version bundle, branch policy
- [Changelog](changelog.md) — latest-version and stable-release history rules
- [Commit Messages](commit-messages.md) — versioned, release, support, and branch-work commit subject rules
- [Canary](canary.md) — pre-commit canary brief pattern
